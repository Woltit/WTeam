 ...
 * @param comment            Супровідний коментар або замітка модератора. Обов'язково заповнюється у разі відхилення запиту (статус {@link com.wteam.backend.common.enums.VerificationStatus#REJECTED REJECTED}) для пояснення причин користувачу. * @see com.wteam.backend.user_profile.UserProfile
